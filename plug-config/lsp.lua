...
vim.cmd("nnoremap <silent> <C-u> <cmd>lua require('lspsaga.action').smart_scroll_with_saga(-1)<CR>")
...
vim.api.nvim_set_keymap("i", "<C-l>", "compe#confirm()", {noremap = true, silent = true, expr = true})
